...
fwlite_WZ_lep_LO_order2_15weights.xsec             = 47.13*(3*0.108)*(3*0.0336) #*2? for both W? #pb WZ*BR(Wlep)*2(W+W-)*BR(Zlep), proc card: p p > l+ vl l- l+, p p > l- vl~ l- l+
...
fwlite_tW_LO_order2_15weights.xsec             = 15.82 * 19.55 / 17.62 #pb LO BSM (gridpack) * NLO SM / LO SM, T_tWch_noFullyHad (x2 for t and tbar, /2 as here ether W or t decays leptonically (double counting)),

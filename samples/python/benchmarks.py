...
gen_dir_v3 = "/afs/hephy.at/data/rschoefbeck01/TTXPheno/skims/gen/v3/"
gridpack_dir = "/afs/hephy.at/data/llechner01/TTXPheno/gridpacks/"

dim6top_ttZ_ll_LO_8weights_order3_07052018 = Sample.fromDirectory("fwlite_ttZ_ll_LO_order3_8weights", texName = "ttZ (current scan)", directory = [os.path.join( gen_dir_v3, "fwlite_ttZ_ll_LO_order3_8weights" )])
dim6top_ttZ_ll_LO_8weights_order3_07052018.reweight_pkl = gridpack_dir + "07052018/ttZ/order3/ttZ0j_rwgt_slc6_amd64_gcc630_CMSSW_9_3_0_tarball.pkl"

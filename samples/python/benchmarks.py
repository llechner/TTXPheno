...
#fwlite_ttgamma1l_LO_order2_15weights_ref.xsec         = 0.5019 * 3.697 / 2.302 #pb ttgamma, xsec_SM_NNLO * xsec_BSM_LO / xsec_SM_LO
...
#fwlite_ttgamma2l_LO_order2_15weights_ref.xsec         = 0.7052 * 3.697 / 2.302 #pb ttgamma, xsec_SM_NNLO * xsec_BSM_LO / xsec_SM_LO
"""
...
fwlite_tt_dilep_LO_order2_15weights.nEvents       = 1000000 #? not checked!
...
fwlite_tt_nonhad_LO_order2_15weights.nEvents       = 1000000 #? not checked!
...
fwlite_tt1l_LO_order2_15weights.xsec          =  * 831.76 / 485.8 #pb tt1l*tt_NNLO/tt_LO, tt, proc card: p p > t t~, (t > w+ b, w+ > l+ vl), (t~ > w- b~, w- > l- vl~)
...
fwlite_tt2l_LO_order2_15weights.xsec          =  * 831.76 / 485.8 #pb tt2l*tt_NNLO/tt_LO, tt, proc card: p p > t t~, (t~ > w- b~, w- > l- vl~) +  p p > t t~, (t > w+ b, w+ > l+ vl)
"""

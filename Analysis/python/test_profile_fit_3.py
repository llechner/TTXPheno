...
pWs.factory( "lumi_kappa[1.045]" )
#pWs.factory( "cexpr::alpha_lumi('pow(lumi_kappa,beta_lumi)',lumi_kappa,beta_lumi[0,-5,5])" )
pWs.factory( "beta_lumi[1,0.0001,10000]" )
#fac = 5*log(1.045)
pWs.factory( "glob_lumi[1,0.0001,10000]")#%(exp(-fac),exp(fac)) )
pWs.factory( "RooLognormal::constr_lumi(beta_lumi,glob_lumi, 1.)" ) 
pWs.factory( "cexpr::alpha_lumi('pow(lumi_kappa,beta_lumi)',lumi_kappa,beta_lumi)" )
pWs.factory( "prod::lumi(lumi_nom,alpha_lumi)" )

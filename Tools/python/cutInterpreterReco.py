...
discrete_variables  = [ ("nlepttgamma2l", "Sum$(recoLep_pt>15&&(abs(recoLep_pdgId)==11||abs(recoLep_pdgId)==13)&&abs(recoLep_eta)<=2.4)"), ("nlep", "Sum$(recoLep_pt>10&&(abs(recoLep_pdgId)==11||abs(recoLep_pdgId)==13)&&abs(recoLep_eta)<2.5)"), ("njet", "Sum$(recoJet_pt>30&&abs(recoJet_eta)<2.4)"), ("nbjet_loose", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**0))&&abs(recoJet_eta)<2.4)"), ("nbjet_medium", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**1))&&abs(recoJet_eta)<2.4)"),("nbjet_tight", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**2))&&abs(recoJet_eta)<2.4)"),("nbjet_looseMTD", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**3))&&abs(recoJet_eta)<2.4)"),("nbjet_mediumMTD", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**4))&&abs(recoJet_eta)<2.4)"),("nbjet_tightMTD", "Sum$(recoJet_pt>30&&(recoJet_bTag&(2**5))&&abs(recoJet_eta)<2.4)"),("nbjet", "Sum$(recoJet_pt>30&&recoJet_bTag>=1&&abs(recoJet_eta)<2.4)") , ]

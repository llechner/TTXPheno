...
argParser.add_argument('--version',         action='store',     default='wcCheck', help='Appendix to plot directory') 
...
argParser.add_argument('--parameters',      action='store',     default = ['ctW', '3', 'ctWI', '3', 'ctZ', '3', 'ctZI', '3', 'cpQM', '3', 'cpt', '3', 'ctG', '1', 'ctGI', '1'], type=str, nargs='+', help = "argument parameters")
...
if args.processFile.split('_')[0] == 'ttgamma':
    ...
    ttgammabSample.name = 'fwlite_ttgamma_(b)_LO_order2_15weights'
    ...
    ttZIsrSample.name = 'fwlite_ttgamma_(non-t)_LO_order2_15weights_ref'
...
#    ttXSample.addSelectionString(    "isrPhoton==1" )
#    wcCheck = 'ISR_as_signal'

#    ttXSample.addSelectionString(    "lepPhoton==1" )
#    wcCheck = 'isoWltau_as_signal'

#    ttXSample.addSelectionString(    "bottomPhoton==1" )
#    wcCheck = 'isoB_as_signal'

    ttXSample.addSelectionString(         "signalPhoton==1" ) #cat a1 <- the one and only signal
    wcCheck = 'signal_as_signal'
...
#    wcCheck = 'signal_as_signal'
    ...
    ttXSample.addSelectionString( "signalZ==0" ) #cat a1 <- the one and only signal
    wcCheck = 'Znont_as_signal'

...
ttZ     = { '2D':[
            ...
            '3D':[
                  ...
                  { 'index':3, 'plotstring':'p_{T}(Z) : #phi(E_{T}^{miss})', 'var':'GenMet_phi:Z_pt',     'binning':[ 5, 0, 500, 5, -np.pi, np.pi ] },
                  { 'index':4, 'plotstring':'p_{T}(Z) : #phi(Z)',            'var':'Z_phi:Z_pt',          'binning':[ 5, 0, 500, 5, -np.pi, np.pi ] },
                  { 'index':5, 'plotstring':'p_{T}(Z) : #eta(Z)',            'var':'Z_eta:Z_pt',          'binning':[ 5, 0, 500, 5, -3, 3 ] },

                  { 'index':6, 'plotstring':'cos(#theta*) : #phi(E_{T}^{miss})', 'var':'GenMet_phi:Z_cosThetaStar', 'binning':[ 5, -1.2, 1.2, 5, -np.pi, np.pi ] },
                  { 'index':7, 'plotstring':'cos(#theta*) : #phi(Z)',            'var':'Z_phi:Z_cosThetaStar',      'binning':[ 5, -1.2, 1.2, 5, -np.pi, np.pi ] },
                  { 'index':8, 'plotstring':'cos(#theta*) : #eta(Z)',            'var':'Z_eta:Z_cosThetaStar',      'binning':[ 5, -1.2, 1.2, 5, -3, 3 ] },

...
ttZ     = { 'cut':[
                   { 'index':1, 'plotstring':'p_{T}(Z)',             'var':'genZ_pt',                'binning':[ 5, 0, 500 ],        'plotrange':[ 20, 0, 500],         'binningPerGraph':[ 2, 5, 10, 15, 20 ], 'color':[30, 41, 42, 43, 44] },
            ...
            'bin':[
                   { 'index':1, 'plotstring':'p_{T}(Z)',             'var':'genZ_pt',                'binning':[ 5, 0, 500 ],        'plotrange':[ 10, 0, 50 ],         'cutPerGraph':[0,100,200,300,400], 'color':[30, 41, 42, 43, 44] },
...
ttW     = { 'cut':[
                   { 'index':1, 'plotstring':'p_{T}(W)',             'var':'genW_pt',            'binning':[ 5, 0, 500 ],        'plotrange':[ 20, 0, 500],         'binningPerGraph':[ 2, 5, 10, 15, 20 ], 'color':[30, 41, 42, 43, 44] },
            ...
            'bin':[
                   { 'index':1, 'plotstring':'p_{T}(W)',             'var':'genW_pt',            'binning':[ 5, 0, 500 ],        'plotrange':[ 10, 0, 50 ],         'cutPerGraph':[0,100,200,300,400], 'color':[30, 41, 42, 43, 44] },
...
ttgamma = { 'cut':[
                   { 'index':1, 'plotstring':'p_{T}(#gamma)',        'var':'genPhoton_pt',        'binning':[ 5, 0, 500 ],        'plotrange':[ 20, 0, 500],         'binningPerGraph':[ 2, 5, 10, 15, 20 ], 'color':[30, 41, 42, 43, 44] },
            ...
            'bin':[
                   { 'index':1, 'plotstring':'p_{T}(#gamma)',        'var':'genPhoton_pt',        'binning':[ 5, 0, 500 ],        'plotrange':[ 10, 0, 50 ],         'cutPerGraph':[0,100,200,300,400], 'color':[30, 41, 42, 43, 44] },

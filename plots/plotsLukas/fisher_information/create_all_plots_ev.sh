...
#                    submitBatch.py --dpm "python fisher_information_ev.py ${small} --level ${level} --version ${version} --sample fwlite_ttgamma_LO_order2_15weights_ref --process ttgamma --order 2 --selection gammapt40-nlep1p-njet3p-nbjet1p --variables ${variable} ${parameter} ${fpsScale} --binThreshold ${binThreshold}"
#                    submitBatch.py --dpm "python fisher_information_ev.py ${small} --level ${level} --version ${version} --sample fwlite_ttgamma_LO_order2_15weights_ref --process ttgamma --order 2 --selection gammapt40-nlep2p-njet2p-nbjet1p --variables ${variable} ${parameter} ${fpsScale} --binThreshold ${binThreshold}"

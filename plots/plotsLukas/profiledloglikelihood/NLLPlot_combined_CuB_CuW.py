...
#            c.specifyFlatUncertainty( 'lumi', 1.026 )
        ...
        nameList = ['combined'] + ['cuB','cuW'] + args.binning + [ args.level, args.version, args.order, args.luminosity, 'small' if args.small else 'full', cuB, cuW ]
...
filename = '_'.join( ['nll', 'combined'] + ['cuB','cuW'] + map( str, args.binning ) + [ str(args.luminosity) ] ) + '.data'

...
#combined
nohup krenew -t -K 10 -- bash -c "python ${script}_combined.py ${small} --level ${level} --version ${version} --variables ctZ ctZI --binning 31 -0.3 0.3 31 -0.3 0.3 --luminosity 150 --fit BestFit --zRange ${zRange} --contours --smooth --cores 4 ${overwrite} --binMultiplier ${multiplier}" &

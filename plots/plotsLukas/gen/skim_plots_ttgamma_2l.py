...
def makeLeps( event, sample ):
    ...
    event.passing_2lep    = len(event.leps)>=2

    # Mimick l reconstruction ( if the trailing b fails acceptance, we supplement with the leading non-b jet ) 

...
#declare -a samples2=('fwlite_ttZ_ll_LO_order2_18weights_4f_ref')
...
declare -a selections=('lepSel3-onZ-njet3p-nbjet1p-Zpt0-leptonIso3' 'lepSel3-onZ-njet3p-nbjet1p-Zpt200-leptonIso3')
#declare -a selections=('lepSel3-onZ-njet3p-nbjet1p-Zpt0-leptonIso3')
...
declare -a noninfoSignal=("--noninfoSignal")
                           ...
                           do
                             ...
                             do
                               ...
                               do
                                  ...
                                  echo "python ${prog} --processFile ${process} --luminosity ${luminosity} --version ${version} --level ${level} ${samplesize} ${reweight} ${scale} --sample ${sample} --order ${order} --selection ${selection} ${backgrounds} --parameters cpQM ${cpQM} cpt ${cpt} ctW ${ctW} ctWI ${ctWI} ctZ ${ctZ} ctZI ${ctZI} ${background} ${addFisher} --binThreshold ${binThreshold} --variables ${variable} --leptonFlavor ${flavor} --detector ${detector} ${noninfoSignal}"

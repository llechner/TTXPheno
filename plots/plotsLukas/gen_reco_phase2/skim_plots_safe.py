...
argParser.add_argument('--processFile',     action='store',     default='ttgamma_2l', nargs='?', choices=['ttZ_3l', 'ttZ_4l', 'ttW_2l', 'ttgamma_1l', 'ttgamma_2l', 'ttgamma_1l_small', 'ttgamma_2l_small'], help='Which process? ttZ, ttW, ttgamma') 
...
argParser.add_argument('--selection',       action='store',     default='lepSel2-njet2p-nbjet1p-gammapt40', help="Specify cut.")

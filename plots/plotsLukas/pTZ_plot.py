...
argParser.add_argument('--textsize', action='store', default=0.03, nargs=1)
argParser.add_argument('--process', action='store', default='ttZ', nargs=1)
argParser.add_argument('--lowercut', action='store', default=[], nargs='*', type = str)
argParser.add_argument('--uppercut', action='store', default=[], nargs='*', type = str)
argParser.add_argument('--WC', action='store', default=[], nargs='*', type = str)
...
# Plot Settings
plot_param = param[0] #"Z_pt"
log = False
binning = args.range[0] #50
plot_min = args.range[1] #0
plot_max = args.range[2] #500
textsize = args.textsize

# Naming Settings
shapes = "analysisPlots"
process = args.process #ttZ #ttgamma #ttW
flavor = "all"
plot = plot_param
